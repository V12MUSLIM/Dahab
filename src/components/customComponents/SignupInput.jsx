  ...
  return (
    <div className="space-y-1">
      <div className="relative">
        {Icon && (
          <Icon className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-700 dark:text-gray-500 z-10" />
        )}
        ...
        {type === "password" && (
          <button
            ...
            className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-gray-700 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-300 z-10"
          >
            {showPassword ? (
              <svg
