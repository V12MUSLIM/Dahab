  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-black text-center px-6">
      ...
      <motion.h2
        ...
        className="flex items-center justify-center gap-2 text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-4"
      >
        Forbidden <ShieldAlert className="w-6 h-6 text-red-600" />
      </motion.h2>
      ...
      >
        You are not allowed to view this page content.
      </motion.p>
