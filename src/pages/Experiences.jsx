...
const experiencesByCategory = [
  {
    ...
    experiences: [
      ...
      },
      {
        ...
        imageUrl: 'https://www.iksurfmag.com/wp-content/uploads/2023/04/DSC6405.jpg.jpg',
    ...
    experiences: [
       {
        ...
        imageUrl: 'https://images.pexels.com/photos/3094215/pexels-photo-3094215.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      ...
      },
       {
        ...
        imageUrl: 'https://images.pexels.com/photos/3768916/pexels-photo-3768916.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white">
            Live the Adventure. <span className="text-amber-400">Create Your Memories.</span>
          </h1>
          <p className="mt-4 text-lg md:text-xl text-white max-w-3xl mx-auto">
            Whether you seek thrill and adventure, or peace and relaxation, we offer a range of experiences specially designed to make your trip to Dahab unforgettable.
          </p>
        </div>
      </motion.div>
      </div>
