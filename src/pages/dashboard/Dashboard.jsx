...
const Dashboard = () => {
  ...
  const [recentActivity] = useState([
    { id: 1, type: "booking", user: "John Doe", item: "Cairo Tour Package", time: "5 min ago" },
    { id: 2, type: "user", user: "Jane Smith", item: "New registration", time: "12 min ago" },
    { id: 3, type: "booking", user: "Mike Johnson", item: "Luxor Temple Visit", time: "1 hour ago" }
  ]);
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" onClick={() => navigate("/dashboard/analytics")} className="dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-900 dark:hover:text-white">
              <BarChart3 className="mr-2 h-4 w-4" />
              Analytics
            </Button>
            <Button onClick={() => navigate("/dashboard/destinations")} className="dark:bg-white dark:text-black dark:hover:bg-gray-200">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {statCards.map((stat) => {
            ...
            return (
              <Card key={stat.title} className="dark:bg-zinc-950 dark:border-gray-800">
                        ...
                        <div className="flex items-start gap-3 rounded-lg border border-slate-200 dark:border-gray-800 bg-white dark:bg-black p-4 transition hover:border-slate-300 dark:hover:border-gray-700 hover:bg-slate-50 dark:hover:bg-zinc-950 focus-visible:ring-2 focus-visible:ring-slate-400 dark:focus-visible:ring-gray-600 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-black">
                          ...
                          <div className="flex-1 space-y-1">
                            <div className="flex items-center justify-between">
                              ...
                              {item.count !== null && (
                                <Badge variant={item.status === "pending" ? "default" : "secondary"} className="ml-2 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700">
                                  {item.count}
                                </Badge>
                              )}
                            </div>
          ...
          <div className="space-y-6">
            <Card className="dark:bg-zinc-950 dark:border-gray-800">
              <CardHeader>
                ...
                <CardDescription className="dark:text-gray-400">Latest updates from your platform</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {recentActivity.map((activity) => (
                    <div key={activity.id} className="flex items-start gap-3 pb-3 last:pb-0 border-b dark:border-gray-800 last:border-0">
                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-xs text-slate-600 dark:text-gray-400">{activity.item}</p>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-600 dark:text-gray-400">Database</span>
                    <Badge variant="secondary" className="bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-400 dark:border-green-900">Healthy</Badge>
                  </div>
                  <Progress value={95} className="h-2 dark:bg-gray-900" />
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-600 dark:text-gray-400">API Response</span>
                    <Badge variant="secondary" className="bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-400 dark:border-green-900">Fast</Badge>
                  </div>
                  <Progress value={88} className="h-2 dark:bg-gray-900" />
                </div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-slate-600 dark:text-gray-400">Storage</span>
                    <Badge variant="secondary" className="bg-yellow-100 dark:bg-yellow-950 text-yellow-700 dark:text-yellow-400 dark:border-yellow-900">72%</Badge>
                  </div>
        ...
        <Card className="border-orange-200 dark:border-orange-900 bg-orange-50 dark:bg-orange-950">
          <CardContent className="flex items-start gap-3 p-4">
            ...
            <div className="flex-1">
              <h4 className="font-medium text-orange-900 dark:text-orange-300">Action Required</h4>
              <p className="text-sm text-orange-700 dark:text-orange-400 mt-1">
                You have 12 pending bookings awaiting confirmation. Review them to ensure smooth operations.
              </p>
            </div>
            <Button size="sm" variant="outline" className="border-orange-300 dark:border-orange-800 dark:text-orange-400 hover:bg-orange-100 dark:hover:bg-orange-950" onClick={() => navigate("/dashboard/bookings")}>
              Review
            </Button>
          </CardContent>
        </Card>
